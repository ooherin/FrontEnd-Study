...
class Flower {
  ...
  class Shape{
   ...
   //Shape클래스를 상속받는 하위 rectangle 클래스 생성
   class Rectangle extends Shape{
    //super로 상위 클래스의 this프로퍼티를 상속받는다. 
    //고유의 프로퍼티는 super뒤에 적는다. 
     constructor(height,width){
       super(height,width);
     }
   }
  ...
  class Product{
    ...
    //프로토타입 매서드 : 유전자에 있는 메소드. 하위 인스턴스가 공통으로 사용가능
    //인스턴스마다 중복 생성되지 않는다는 장점이 있다.
    getPrice(){
